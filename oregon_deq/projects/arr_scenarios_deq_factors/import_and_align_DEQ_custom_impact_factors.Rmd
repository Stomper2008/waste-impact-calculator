...
This R Markdown notebook documents my work to import DEQ's in-house impact factors for the Waste Impact Calculator, and align them with the materials and disposition names found in DEQ's solid waste data (which have already been imported and should be found in the folder /waste-impact-calculator/oregon_deq/projects/arr_scenarios_deq_factors/intermediate_output/observedWaste.RData).
...
impactFactorsSelected <-
  ...
  # eliminating some technical variables not necessary for further work
...
impactFactorsIMFOapp <-
  filter(impactFactorsIMFOapp, material != "Wood")
```
